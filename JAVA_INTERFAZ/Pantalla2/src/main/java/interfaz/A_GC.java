 ...
 * @author erick
 */
public class A_GC extends javax.swing.JFrame {

    /**
     * Creates new form A_GC
     */
    public A_GC() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(A_GC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
